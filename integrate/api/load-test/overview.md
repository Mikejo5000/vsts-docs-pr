...
### Prerequisites
* For using the REST APIs, enable Basic authentication as detailed [here](../../get-started/auth/overview.md).
...
* Uploading the files and downloading the results are also achieved through the Azure Storage APIs as results are stored as Azure Blobs. Refer to [sample][3] for details of downloading and importing the the load test results.
