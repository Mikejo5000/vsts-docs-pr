...
- Consider granting the [work item quyery folders **Contribute**](../work/track/set-query-permissions.md) permission to users or groups that require the ability to create and share work item queries for the team project.  
