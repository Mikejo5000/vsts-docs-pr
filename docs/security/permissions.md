...
<tbody valign="top">
	...
	<tr>
		...
		<td>
			Can [create an inherited process](../settings/work/process/manage-process.md). Applies to VSTS only.
		</td>
	</tr>
	<tr>
		<td id="delete-process-permission">Delete process</td>
		<td>
			Can [delete an inherited process](../settings/work/process/manage-process.md). Applies to VSTS only.
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			Can edit a [custom inherited process](../settings/work/process/customize-process.md). Applies to VSTS only.
		</td>
	</tr>
	<tr>
		<td id="make-requests-on-behalf-of-others-permission">Make requests on behalf of others</td>
