...
8. If the Free access to Pipelines Preview feature is off, Stakeholders can only  [View releases](../build-release/concepts/definitions/release/approvals/index.md)  and [Approve releases](../build-release/concepts/definitions/release/approvals/index.md).
