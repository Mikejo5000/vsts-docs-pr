...
Codex Repos is one of several cloud service applications provided in the Azure Codex suite of applications.
...
<img src="../user-guide/_img/services/code-git-hub.png" alt="Code hub, Git, files page" style="border: 2px solid #C3C3C3;" />
...
[![Sign up for Codex Repos](../user-guide/_img/what-is-vsts-sign-up-step-1.png)](sign-up-invite-teammates.md)[![Add code to repository](../user-guide/_img/what-is-vsts-add-code-ide-step-2.png)](code-with-git.md) 


## Try this next  

> [!div class="nextstepaction"]
> [Sign up and invite team mates](../user-guide/sign-up-invite-teammates.md?toc=/vsts/codex-agile/toc.json&bc=/vsts/codex-agile/breadcrumb/toc.json )
