...
Try signing out completely from Azure DevOps Services by completing the following steps. Closing your browser might not sign you out completely from Azure DevOps Services. Sign in again to Azure DevOps Services and select your other identity:
