...
Both options are enterprise-ready, supporting teams of any size, from tens to thousands. Team Services provides a scalable, reliable, and globally available hosted service. It is backed by a 99.9% SLA, monitored by our 24Ã—7 operations team, and available in local data centers around the world.
...
<blockquote style="font-size: 13px">**Feature availability:**&#160&#160Both Package Management and Code Search are in preview. Package Management is available only from Team Services. Initially the Package Management service supports NuGet packages and private feeds that are only visible within your teams or team projects.</blockquote>  
...
In addition to continuous integration testing, you can create [test plans](test/manual-exploratory-testing/getting-started/create-a-test-plan.md), [perform manual testing](test/manual-exploratory-testing/index.md), and [run unit tests](test/developer-testing/index.md). 
...
<li style="margin-bottom:2px">[Unit tests](test/developer-testing/index.md)</li>
...
Once you've signed up for Team Services or installed TFS, you'll want to get familiar with the [web portal and its navigational structure](connect/work-web-portal.md).    

Other topics of interest:  
 
- [Feature index](alm-devops-features.md)  
- [Set up Team Services or Team Foundation Server](setup-admin/get-started.md)
- [What's new for Team Foundation Server 2015](whats-new.md)  
- [Visual Studio product guide, cases studies, white papers, forums, videos, and other resources](https://www.visualstudio.com/explore/app-lifecycle-management-vs) 

### TFS updates

- [Team Foundation Server 2017 (RTW)](https://www.visualstudio.com/en-us/news/releasenotes/tfs15-relnotes)  
- [Team Foundation Server 2015 Update 3](https://www.visualstudio.com/news/releasenotes/tfs2015-update3-vs)  
- [Team Foundation Server 2015 Update 2](https://www.visualstudio.com/news/tfs2015-update2-vs)  
- [Team Foundation Server 2015 Update 1](https://www.visualstudio.com/news/tfs2015-update1-vs)    
- [Team Foundation Server 2015 RTM](https://www.visualstudio.com/news/tfs2015-vs)  
...
<li style="margin-bottom:2px">[Basic authorization](../integrate/get-started/auth/overview.md)</li>
