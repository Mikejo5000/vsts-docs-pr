...
The first time that you set up billing for your Azure DevOps Services organization, whether you do the setp up via the Azure portal or as part of making a purchase in the Visual Studio Marketplace, you need:
