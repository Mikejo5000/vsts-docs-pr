...
<p>If you are using the [hosted agents](../../agents/hosted.md), then the tools are set up for you. If you are using on-premises [Windows agent](../../actions/agents/v2-windows.md), then if you select:</p>
<ul>
