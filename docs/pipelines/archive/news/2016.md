...
**No charge for private agents:** [Private agents](../../../pipelines/concepts/agents/agents.md) are now free. In VSTS, you used to have to license each private agent after the first. Now you can run deployments concurrently for no additional charge.
...
[Concurrent pipelines for your builds and releases in VSTS](../../../pipelines/concepts/licensing/concurrent-pipelines-ts.md)
