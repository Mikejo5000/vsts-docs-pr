...
[Configure TFS authentication](../../agents#configure-tfs-authentication) to enable your agents to use different authentication methods.
...
New: [Configure TFS authentication for your private build and release agents](../../agents#configure-tfs-authentication)
