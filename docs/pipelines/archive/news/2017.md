...
[Configure TFS authentication](../../agents/agents#configure-tfs-authentication) to enable your agents to use different authentication methods.
...
New: [Configure TFS authentication for your private build and release agents](../../agents/agents#configure-tfs-authentication)
