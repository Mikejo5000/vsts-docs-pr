...
title: Warnings and errors | Microsoft IntelliTest Developer Test Tool | Visual Studio
description: Warnings and errors for Microsoft Visual Studio IntelliTest developer testing tool
