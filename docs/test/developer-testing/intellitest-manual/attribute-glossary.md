...
title: Attribute glossary | Microsoft IntelliTest Developer Test Tool | Visual Studio
description: Attribute glossary for Microsoft Visual Studio IntelliTest developer testing tool
