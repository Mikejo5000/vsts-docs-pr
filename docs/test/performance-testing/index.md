...
Performance test your code with hundreds of thousands of users using 
...
* Of course you can [run your performance test from on-premises agents](https://docs.microsoft.com/visualstudio/test/lab-management/using-a-lab-environment-for-your-application-lifecycle) too!<p />
