...
1. If this is the first test you have created, you will see the
   ...
   In the **HTTP archive** section, choose **Create test**. 

   ![Get started page for load testing](_img/record-and-replay-cloud-load-tests/HTTPArchiveLoadTestVSO-get-started.png)
...
[run the tests using Visual Studio](#exportvs).
