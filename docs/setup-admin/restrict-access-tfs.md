...
By [setting permissions on an area path](../work/customize/set-area-paths.md), you can deny a group or individual the ability to create or edit work items assigned under an area path.
...
[Set permissions on a shared query or query folder](../work/customize/set-area-paths.md) 
