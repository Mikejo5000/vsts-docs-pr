...
> [!div class="checklist"]   
> * Add a sprint to your project 
> * Select the sprint for your team to use
...
0. If you haven't yet enabled the new Agile hubs feature, do that now. 

0. From your product backlog, turn on **Planning**. While you're at it, make sure Parents and Forecasting are Off. You can choose to set In Progress items to Off. 
...
<!--- Check with Sondra about what permissions needed to add a sprint or select a sprint --> 
...
Before you start planning your sprint, you'll want to have [created, prioritized, and estimated your backlog](../backlogs/create-your-backlog.md). Also, you may want to add the Iteration Path to the set of columns that appear on your backlog. To learn  how, see [Change column options](../backlogs/set-column-options.md). 
...
0. Check the level of effort displayed in the sprint window. 
	...
	This represents your initial guess at what your team will be able to complete in the sprint. Next, you'll define tasks, estimate that work, and use your team's capacity to make sure it fits in the sprint. 
