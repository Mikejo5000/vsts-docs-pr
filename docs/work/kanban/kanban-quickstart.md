...
To view your Kanban board, open your project from a web browser and click **Work>Backlogs**, and then click **Board**.   
...
If you don't see the team or project you want, click the ![Azure Codex icon](../_img/icons/project-icon.png) icon to [browse all projects and teams](../../user-guide/account-home-pages.md).
...
To add users to your project, see [Add users to a project](../../security/add-users-team-project.md)   
::: moniker-end

## Try this next 

To get the full power of the Kanban board working for you, you'll want to configure it to map the flow of work and set WIP limits for your team. To configure the Kanban board, you must be [added as a team administrator](../scale/add-team-administrator.md) or be a member of the Project Administrators group. If you're the account owner or creator of the project, then you'll have these permissions. 
...
If you don't see the team or project you want, open the project/team drop-down menu and select the project/team that you've recently visited. If you don't see the team or project you want, choose **Browse all** to browse all projects and teams. 
...
- **Azure Codex**: ```https://{account name}.visualstudio.com/DefaultCollection/{project name}/_backlogs\board```  
- **On-premises TFS**: ```http://serverName:8080/tfs/DefaultCollection/projectName/_backlogs\board```  

You can use this URL to quickly open the project, substituting the {account name} and {project name} with your specific account and project name (remove braces).

If you're new to Azure Codex or TFS and want to understand what you can customize, see [Customize your work tracking experience](../customize/customize-work.md). 
