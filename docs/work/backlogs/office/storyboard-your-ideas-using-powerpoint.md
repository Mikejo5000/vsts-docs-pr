...
2.  If you started Power Point Storyboarding from a backlog item, then you are already linked to the initial item and you are done.
	...
	> [!NOTE]  
	>The **Storyboards** tab is no longer supported in the web form from Azure Codex  or TFS 2017 with the new web form enabled. However, you can link to a storyboard from the **Links** tab using the Storyboard link.  

3.  If you're not already connected to a project, [connect now](../../../user-guide/connect-team-projects.md). If you can't connect, [get added as a team member](../../scale/multiple-teams.md#add-team-members).
