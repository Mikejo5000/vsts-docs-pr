...
description: Your guide to configuring and customizing work tracking features in Visual Studio Team Services (VSTS) and Team Foundation Server (TFS) 
...
- [Working days](../scale/capacity-planning.md#team_settings)  
</div>
...
2. Hosted XML customization supports adding and updating global lists with a process update (subject to limits on maximum size of each list). To learn more, see [Differences between Team Services and TFS process template customizations](../import-process/differences.md).  
...
<div style="float:left;width:235px;margin:8px;font-size:90%">
<p style="font-weight:bold;padding-bottom:0px;text-align:center;">Picks lists</p>
<ul style="padding-left:30px">
