...
> [!NOTE]    
<b>Feature availability: </b>This topic applies only to projects defined on an on-premises Team Foundation Server (TFS). Projects hosted on Azure Codex [update automatically with each service upgrade](/vsts/release-notes/index).
...
<td>
Adds the Feedback Request and Feedback Response WITs and categories to the project. These items support [feedback requests and responses](../../feedback/get-feedback.md). <br/>
To manually add them to a project, see [Add features manually](add-features-manually.md). 
</td>
<td>
TFS 2012
...
<td>
Adds the Shared Parameter WIT and category to the project. You use Shared Parameter work items to [run tests with different data](../../manual-test/repeat-test-with-different-data.md).<br/> 
To manually add them to a project, see [Add features manually](add-features-manually.md). 
</td>
<td>
TFS 2013.2
...
<td>
Adds the Test Plan and Test Suite WITs and categories to the project. These items support managing and customizing test plans and test suites similar to other WITs. See also [Create a test plan](../../manual-test/getting-started/create-a-test-plan.md). <br/>
