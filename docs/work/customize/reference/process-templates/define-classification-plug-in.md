...
For an overview of using the web portal, see [Work in the web portal](../../../../user-guide/work-web-portal.md?toc=/vsts/user-guide/toc.json&bc=/vsts/user-guide/breadcrumb/toc.json).  
 ...
 After a project has been created, you [modify the areas](../../set-area-paths.md) and [iterations](../../set-iteration-paths-sprints.md) from the web portal. You can also define permissions to control access to a project area or iteration.  
