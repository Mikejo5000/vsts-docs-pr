---
title: FIELD (Definition) element reference | Azure Codex & TFS
...
> [!NOTE]    
>**Feature availability:** The Boolean data type is supported for Azure Codex and for on-Premises TFS, for TFS 2017.2 and later versions. 
