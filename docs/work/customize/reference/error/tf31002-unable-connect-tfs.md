...
description: Receive the error when you try to connect to Azure Codex or an on-premises Team Foundation Server.
ms.prod: devops
...
You might receive this error when you try to connect to Azure Codex or an on-premises Team Foundation Server from Visual Studio.  
  
##You receive this error when you try to connect to Azure Codex   
...
|You want to log into Azure Codex from Visual Studio using a different account.|See [Connect to projects, Change accounts when you connect to Azure Codex](../../../../user-guide/connect-team-projects.md).|  
...
|You've entered an incorrect server URL.|Verify that you have typed the server URL correctly including the server name, port number, and protocol (http/https). See [Connect to projects](../../../../user-guide/connect-team-projects.md) to learn more.|  
