...
> [!IMPORTANT]  
>This topic applies to team project customization for Hosted XML and On-premises XML process models. For defining custom pick lists for the Inheritance process model, see [Customize a field for a process](../../../settings/work/customize-process-field.md). 
>
