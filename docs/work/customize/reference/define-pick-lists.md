---
title: Define pick lists | Azure Codex & TFS
...
> [!IMPORTANT]  
>This topic applies to project customization for Hosted XML and On-premises XML process models. For defining custom pick lists for the Inheritance process model, see [Customize a field for a process](../../../settings/work/customize-process-field.md). 
>
...
-  [Customize a process for import into Azure Codex(Hosted XML)](../import-process/customize-process.md)
