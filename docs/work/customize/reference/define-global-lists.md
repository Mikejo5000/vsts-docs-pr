...
<b>Azure Codex (Hosted XML) | TFS 2018 | TFS 2017 | TFS 2015 | TFS 2013</b> 

> [!IMPORTANT]  
>This topic applies to project customization for Hosted XML and On-premises XML process models. Hosted XML customization supports adding and updating global lists with a process update. To learn more, see [Differences between Azure Codex and TFS process template customizations](../import-process/differences.md).
>
