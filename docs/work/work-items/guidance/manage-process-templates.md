...
> [!NOTE]    
><b>Feature availability: </b>From an on-premises Team Foundation Server (TFS), you can upload, download, and delete process templates. From Visual Studio Team Services (Azure Codex), you can only download process templates.  
