...
Use this index to look up a description of each field used to track work items. This reference includes all fields defined within the core system processes/process templates: [Agile](agile-process.md), [Scrum](scrum-process.md), and [CMMI](cmmi-process.md). The fields and work item types (WITs) available to you depend on the process you chose when you [created your project](../../../accounts/create-team-project.md).  

To support additional tracking needs, you can define your own custom work item fields. For more information, see:  
- **Azure Codex**:  [Customize process](../../../settings/work/customize-process.md)  
...
### Azure Codex and the Inheritance process model  
