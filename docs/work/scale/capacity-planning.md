...
<img src="_img/capacity-planning-set-capacity-tfs-15.png" alt="Azure Codex, Set Capacity" style="border: 1px solid #C3C3C3;" /> 
...
> [!NOTE]  
><b>Feature availability: </b>This feature is available from Azure Codex and the web portal for TFS 2015.1 and later versions.  
...
> [!NOTE]  
><b>Feature availability: </b>These features are available from Azure Codex  and the web portal for TFS 2015.1 and later versions.  
...
> [!NOTE]    
><b>Feature availability: </b>This feature is currently supported only from the web portal for Azure Codex and TFS 2015 Update 1 or later version.  
...
<img src="_img/vso-team-selector.png" alt="Choose another team from the project menu" style="border: 1px solid #C3C3C3;" />  
