...
> [!IMPORTANT]  
>This topic describes how to manage alerts or email notifications when working from the web portal for an on-premises TFS. If you work in Azure Codex and TFS 2017.1 or later version, see [Manage your notifications](../../notifications/manage-personal-notifications.md) and  [Manage notifications for a team](../../collaborate/manage-team-notifications.md). 
...
- [Manage your notifications](../../notifications/manage-personal-notifications.md) (Azure Codex, TFS 2017.1)
- [Manage notifications for a team](../../collaborate/manage-team-notifications.md) (Azure Codex, TFS 2017.1) 
- [Profile preferences](../../accounts/account-preferences.md)  
- [Work effectively from your organizational hub](../../user-guide/account-home-pages.md) (Azure Codex, TFS 2017.1)
