...
<blockquote><strong>Note:</strong> Separate values with the list separator that corresponds to the regional settings that are defined for your client computer. For example, you might use a comma(,).
</blockquote>
...
<tr>
	...
	<td><p> <strong>String</strong> that matches the name of a security group or a category group defined for a project.</p>
