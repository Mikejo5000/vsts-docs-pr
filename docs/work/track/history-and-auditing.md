...
description: Track changes and use tools to support audit requirements when working in Azure Code and Team Foundation Server (TFS) 
...
<img src="_img/hist-audit-wi-form-vsts-tab.png" alt="View History tab - Azure Codex" style="border: 1px solid #C3C3C3;" /> 
...
<img src="_img/hist-audit-wi-form.png" alt="History tab - Azure Codex" style="border: 1px solid #C3C3C3;" /> 
