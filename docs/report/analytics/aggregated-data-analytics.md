...
This returns a result similar to the following:
    ...
    {
      "@odata.context":"https://[collection].analytics.visualstudio.com/_odata/$metadata#WorkItems(WorkItemType,Count)","value":[
        {
...
```
{
  "@odata.context":"https://[account].analytics.visualstudio.com/_odata/$metadata#WorkItems(SumOfCompletedWork,SumOfRemainingWork)","value":[
    {
