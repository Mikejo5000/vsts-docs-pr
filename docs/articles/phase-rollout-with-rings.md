...
> [!NOTE]
>
> Review [CI/CD Pipelines](https://aka.ms/cicdpipelines) and [Approvals](/vsts/pipelines/concepts/definitions/release/approvals/index) for detailed documentation of pipelines and the approval features for release management.
...
Refer to [Variables in Release Management](/vsts/pipelines/concepts/definitions/release/variables).
