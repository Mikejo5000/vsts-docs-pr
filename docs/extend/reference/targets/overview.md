...
>[!NOTE] To learn more about the VSTS extensibility model, see [contribution model](../../develop/contributions-overview.md) for an overview.
...
Tasks are responsible for performing work in a build or release. Learn how to [contribute a build or release task](../../develop/add-built-task.md).
