...
<li style="margin-bottom:1px">[New Account Landing page](../connect/account-home-pages.md) (Team Services)</li>
<li style="margin-bottom:1px">[New Build Editor](../build/preview/2017-user-experience.md) (Team Services)</li>
<li style="margin-bottom:1px">[New Work Item Search](../search/workitem/get-started.md) (Team Services)</li>
...
<li style="margin-bottom:1px">[New Account Landing page](../connect/account-home-pages.md) (Team Services)</li>
<li style="margin-bottom:1px">[New Build Editor](../build/preview/2017-user-experience.md)  (Team Services)</li>
<li style="margin-bottom:1px">[Out of the box notifications](#oob-notifications) (TFS 2017.1)</li> 
<li style="margin-bottom:1px">[Task Conditions](#task-conditions)</li> 
<li style="margin-bottom:1px">[Task tool installers](#task-tool-installers)</li> 
<li style="margin-bottom:1px">[Team expansion for notifications](#team-expansion-notifications) (Team Services)</li>
</ul>
...
>[!NOTE]  
>**Feature availability**: You can enable/disable the [New Build Editor](../build/preview/2017-user-experience.md) from Team Services accounts only. 
...
<a id="task-conditions">  </a>
### Task conditions

>[!NOTE]  
>**Feature availability**: This feature is available from Team Services. You enable this feature for the account level by first turning on the **New Build Editor**. After you've done that, close the **Preview features** menu, then open it again, select **for this account**, and then enable the **Task Conditions** option.

Have you been looking for more control over your build tasks? For example, do you want to clean things up, send a message, or do some other kind of housekeeping when something goes wrong? Enable this feature for your account so that your team can choose some standard options and even express custom conditions under which you want your build task to run. See [Specify conditions for running a task](../build/concepts/process/conditions.md)
