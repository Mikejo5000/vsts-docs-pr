...
<div class="group" style="float:left;width:250px;margin:3px;font-size:70%">
                        <h3 style="margin:0;">Get Started Guides</h3>
                        <ul class="noBullet">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Work (Agile)</h3>
                        <ul class="noBullet">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Code (Repos)</h3>
                        <ul class="noBullet">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Build & Release (Pipelines)</h3>
                        <ul class="noBullet">
...
<div class="group" style="float:left;width:250px;margin:3px;font-size:70%">
                        <h3 style="margin:0;">Azure DevOps Project</h3>
                        <ul class="noBullet">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Web App Deployment</h3>
                        <ul class="noBullet">
...
<div class="group" class="cardText" style="float:left;width:250px;margin:3px;font-size:70%">
                        ...
                        <h3 style="margin:0;">Discover & Manage Extensions</h3>
                        <ul class="noBullet">
                        ...
                        <h3 style="margin:0;">Build Extensions</h3>
                        <ul class="noBullet">
...
<div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Command-line tools</h3>
                        <ul class="noBullet">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Office Integration tools</h3>
                        <ul class="noBullet">
       ...
       <div class="group" style="float:left;width:250px;margin:35px;font-size:70%">
                        <h3 style="margin:0;">Task-specific clients</h3>
                        <ul class="noBullet">
