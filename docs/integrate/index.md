...
You can build custom applications or services that integrate with your Visual Studio Team Services (VSTS) and Team Foundation Server (TFS) accounts by using the [REST APIs](rest-api-overview.md) to make direct HTTP calls, or utilize our [.NET Client Libraries](./concepts/dotnet-client-libraries.md).
