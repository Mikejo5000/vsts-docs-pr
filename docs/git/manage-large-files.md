...
0. Git LFS does not address the problem of concurrent updates to binary files. Git cannot merge the changes from two different versions of a binary file even if both versions have a common parent.
