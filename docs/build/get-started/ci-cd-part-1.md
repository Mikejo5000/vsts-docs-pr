...
1. Create an a Visual Studio Team Service account. Keep the option to use **Git** selected.
...
1. Enable the **New Build Editor** [preview feature](../../collaborate/preview-features.md) for your account. 
