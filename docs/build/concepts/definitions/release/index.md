---
title: Release Definitions for Visual Studio Team Services and Team Foundation Server
...
A **release definition** is one of the fundamental concepts in Release Management. It defines the end-to-end release process for an application to be deployed across various environments.
