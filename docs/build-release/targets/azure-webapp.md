...
TFS can automatically deploy your web packages to Azure web app after every successful build. Make sure that you have completed the [Your first build and release](../build/hello-world.md) quickstart before trying the steps in this article.
