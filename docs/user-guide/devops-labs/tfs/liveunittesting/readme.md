---
title: Live Unit Testing, Code Coverage, and Code Clone Analysis
description: Live Unit Testing, Code Coverage, and Code Clone Analysis with Visual Studio 2017
ms.prod: vs-devops-alm
ms.technology: 
ms.assetid: D3C06791-0439-4B90-997B-464E9BD83361 
ms.manager: douge
ms.author: sraj 
ms.date: 01/25/2018
---
