---
title: UI Automation using Coded UI Tests with Visual Studio 
description: UI Automation using Coded UI Tests with Visual Studio Enterprise 2017
ms.prod: vs-devops-alm
ms.technology: 
ms.assetid: 22916F51-2265-4B27-ADC3-EAA48E7D3F9A 
ms.manager: douge
ms.author: sraj 
ms.date: 01/25/2018
---

# UI Automation using Coded UI Tests with Visual Studio
