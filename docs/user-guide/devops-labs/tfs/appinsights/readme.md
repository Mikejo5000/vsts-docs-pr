---
title: Instrumenting ASP.NET with Application Insights
description: Instrumenting ASP.NET with Application Insights in Visual Studio 
ms.prod: vs-devops-alm
ms.technology: 
ms.assetid: A98FB8C9-BBE6-483F-9462-B495EA9BD1B4 
ms.manager: douge
ms.author: sraj 
ms.date: 01/25/2018
---

# Instrumenting ASP.NET with Application Insights in Visual Studio 
