---
title: ReadyRoll - Develop and deploy databases
description: ReadyRoll- Develop and deploy databases in Visual Studio Enterprise 2017
ms.prod: vs-devops-alm
ms.technology: vs-devops-build
ms.assetid: 5AE3D9A5-AC14-4A2D-9781-6A58CF83A15F
ms.manager: douge
ms.author: ahomer 
ms.date: 01/25/2018
---

# ReadyRoll - Develop and deploy databases
