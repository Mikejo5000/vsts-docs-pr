...
You can configure Team Foundation ServerÂ to use the standard configuration.Â To complete this procedure, you must have a domain account.Â 
...
You must be a member of the **Administrators** security group on the server that is running TFS.Â 
