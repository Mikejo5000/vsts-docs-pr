...
Refer to  [Create Deployment Groups](https://docs.microsoft.com/en-us/vsts/pipelines/concepts/definitions/release/deployment-groups/#create-a-deployment-group).
