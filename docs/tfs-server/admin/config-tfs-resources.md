...
> |Application tierÂ Â |Data tierÂ Â |Â 
> |-------------|----------|
...
> [!div class="mx-tdBreakAll"]
> |Team project collectionsÂ Â |Team projectsÂ Â |Â 
> |-------------|----------|
...
> [!div class="mx-tdBreakAll"]
> |Reports, documents, and dashboardsÂ Â |Service accounts, application pools, and websitesÂ Â |Â 
> |-------------|----------|
