...
You should have a project specific **_.npmrc_** containing only your Feedâ€™s registry information that you discovered from the "Connect to Feed" dialog.  There should be no credentials in this file and the file itself is usually adjacent to your projectâ€™s **_package.json_**.
