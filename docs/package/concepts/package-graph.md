...
![3 feeds with no upstream sources](_img/1.svg)
...
![Contoso adds an upstream to AdventureWorks](_img/2.svg)
...
![Fabrikam adds an upstream source to Contoso](_img/3.svg)
...
![Fabrikam cannot access AdventureWorks packages unless they've been saved by Contoso](_img/4.svg)